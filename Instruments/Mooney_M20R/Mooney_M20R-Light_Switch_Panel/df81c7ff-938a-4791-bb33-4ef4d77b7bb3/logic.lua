...
msfs_variable_subscribe("LIGHT STROBE ON", "Bool", new_strobe_pos)
...
msfs_variable_subscribe("LIGHT NAV ON", "Bool", new_nav_pos)
...
msfs_variable_subscribe("LIGHT RECOGNITION", "Bool", new_recog_pos)
...
msfs_variable_subscribe("LIGHT TAXI", "Bool", new_taxi_l_pos)
...
msfs_variable_subscribe("LIGHT TAXI", "Bool", new_taxi_r_pos)
...
msfs_variable_subscribe("LIGHT LANDING", "Bool", new_landing_l_pos)
...
msfs_variable_subscribe("LIGHT LANDING", "Bool", new_landing_r_pos)
