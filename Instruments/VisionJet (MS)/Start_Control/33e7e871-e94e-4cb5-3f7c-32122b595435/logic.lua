--[[
******************************************************************************************
************************ CIRRUS SF50 VISION JET MS START CONTROL *****************************
******************************************************************************************
...
Start control for the Vision Jet by MS/Asobo
...
function ignition()
    if arm_pos == 0 then
        msfs_event("B:SF50_ENGINE_RUN_KNOB", 1)
    else
        msfs_event("B:SF50_ENGINE_RUN_KNOB", 0)
    end
end
...
function set_start_switch_msfs(position)
    if position == 0 then
...
msfs_variable_subscribe("B:SF50_ENGINE_RUN_KNOB", "Enum", set_start_switch_msfs)
