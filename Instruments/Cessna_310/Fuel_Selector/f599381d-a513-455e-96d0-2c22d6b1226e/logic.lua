...
function right_left_main()
    ...
    msfs_variable_write("L:C310_SW_FUEL_SEL_RIGHT", "Enum", 2)
end
...
function right_aux_main()
    ...
    msfs_variable_write("L:C310_SW_FUEL_SEL_RIGHT", "Enum", 1)
end
...
function right_left_main()
    rotate(lever_r, -90, 57, 149, 0, "LINEAR", 0.05, "DIRECT")
    msfs_variable_write("L:C310_SW_FUEL_SEL_RIGHT", "Enum", 0)
end
...
function right_off_main()
    ...
    msfs_variable_write("L:C310_SW_FUEL_SEL_RIGHT", "Enum", 3)
end
...
msfs_variable_subscribe("L:C310_SW_FUEL_SEL_LEFT", "Enum", fuel_left)
...
msfs_variable_subscribe("L:C310_SW_FUEL_SEL_RIGHT", "Enum", fuel_right)
