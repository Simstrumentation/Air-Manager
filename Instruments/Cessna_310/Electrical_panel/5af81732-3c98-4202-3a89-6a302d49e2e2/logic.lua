...
function pump_l_cb(position, direction)
    ...
    msfs_variable_write("L:C310_SW_FUEL_PUMP_LEFT", "Enum", new_pos)
end
...
msfs_variable_subscribe("L:C310_SW_FUEL_PUMP_LEFT", "Enum", l_pump_cb)

-- r aux pump
function pump_r_cb(position, direction)
    new_pos = position + direction
    msfs_variable_write("L:C310_SW_FUEL_PUMP_RIGHT", "Enum", new_pos)
end
...
msfs_variable_subscribe("L:C310_SW_FUEL_PUMP_RIGHT", "Enum", r_pump_cb)

--primer 
function primer_cb(position, direction)
    new_pos = position + direction
    msfs_variable_write("L:C310_SW_PRIMER", "Enum", new_pos)
end
...
msfs_variable_subscribe("L:C310_SW_PRIMER", "Enum", set_primer)


--Starter L
function start_l_press_cb()
    msfs_event("SET_STARTER1_HELD")
end
...
msfs_variable_subscribe("L:C310_SW_ALTERNATOR_LEFT", "Number", set_alt_l)
...
msfs_variable_subscribe("ELECTRICAL MASTER BATTERY", "Bool", set_master)
...
msfs_variable_subscribe("L:C310_SW_ALTERNATOR_RIGHT", "Number", set_alt_r)
...
msfs_variable_subscribe("L:C310_SW_MAG_LEFT_1", "Number", set_mag_l_l)
...
msfs_variable_subscribe("L:C310_SW_MAG_RIGHT_1", "Number", set_mag_l_r)
...
msfs_variable_subscribe("L:C310_SW_MAG_LEFT_2", "Number", set_mag_r_l)
...
msfs_variable_subscribe("L:C310_SW_MAG_RIGHT_2", "Number", set_mag_r_r)
