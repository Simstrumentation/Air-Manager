...
function heat_switch_cb(position, direction)
    ...
    msfs_variable_write("L:C310_SW_HEATER", "Enum", new_pos)
end
...
msfs_variable_subscribe("L:C310_SW_HEATER", "Enum", heat_pos)
 
--Overheat indicator

function overheat_cb()  
    msfs_variable_write("L:C310_Overheat_Test", "Number", 1)
end

function overheat_release_cb()
    msfs_variable_write("L:C310_Overheat_Test", "Number", 0)
end
...
msfs_variable_subscribe("L:C310_WL_Overheat", "Number", overheat_set)
...
function defrost_cb(direction)
    ...
    msfs_variable_write("L:C310_SW_DEFROST", "Number", var_round(defrost_percent, 1))
...
msfs_variable_subscribe("L:C310_SW_DEFROST", "Number", defrost_dial)
...
function temp_cb(direction)
    ...
    msfs_variable_write("L:C310_SW_TEMP_CONTROL", "Number", var_round(temp_percent, 1))
...
msfs_variable_subscribe("L:C310_SW_TEMP_CONTROL", "Number", temp_dial)
...
function cabin_cb(direction)
    ...
    msfs_variable_write("L:C310_SW_CABIN_AIR", "Number", var_round(cabin_percent, 1))
...
msfs_variable_subscribe("L:C310_SW_CABIN_AIR", "Number", cabin_dial)
...
function fwd_cabin_cb(direction)
    ...
    msfs_variable_write("L:C310_SW_FWD_CABIN_AIR", "Number", var_round(fwd_cabin_percent, 1))
...
msfs_variable_subscribe("L:C310_SW_FWD_CABIN_AIR", "Number", fwd_cabin_dial)