...
--Day Graphics   
img_knob_DSPLY = img_add("round_knob.png", 58,28,65,65)
img_knob_AVI = img_add("round_knob.png", 237,28,65,65)

--Night Graphics
img_knob_DSPLY_night = img_add("round_knob_night.png", 58,28,65,65)
img_knob_AVI_night = img_add("round_knob_night.png", 237,28,65,65)

--Backlighting
img_backlight_knob_DSPLY= img_add("backlight_round_knob.png", 58,28,65,65)
img_backlight_knob_AVI= img_add("backlight_round_knob.png", 237,28,65,65)
...
fs2020_variable_subscribe("L:ASCRJ_DSPL_FAN", "Number",
        function (position)
...
sw_DSPL_FAN = switch_add(nil,nil,nil,nil, 58,28,65,65, "CIRCULAIR",
        function (pos,dir) fs2020_variable_write("L:ASCRJ_DSPL_FAN","Number", pos+dir) end) 
        
fs2020_variable_subscribe("L:ASCRJ_AVIONICS_FAN", "Number",
        function (position)
...
sw_AVI_FAN = switch_add(nil,nil,nil, 237,28,65,65, "CIRCULAIR",
        function (pos,dir) fs2020_variable_write("L:ASCRJ_AVIONICS_FAN","Number", pos+dir) end) 
