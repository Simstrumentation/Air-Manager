...
msfs_variable_subscribe("L:ASCRJ_DSPL_FAN", "Number",
        function (position)
...
sw_DSPL_FAN = switch_add(nil,nil,nil,nil, 58,28,65,65, "CIRCULAIR",
        function (pos,dir) msfs_variable_write("L:ASCRJ_DSPL_FAN","Number", pos+dir) end) 
        
msfs_variable_subscribe("L:ASCRJ_AVIONICS_FAN", "Number",
        function (position)
...
sw_AVI_FAN = switch_add(nil,nil,nil, 237,28,65,65, "CIRCULAIR",
        function (pos,dir) msfs_variable_write("L:ASCRJ_AVIONICS_FAN","Number", pos+dir) end) 
