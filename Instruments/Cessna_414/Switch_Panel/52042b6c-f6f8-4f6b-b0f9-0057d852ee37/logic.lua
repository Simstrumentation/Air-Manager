...
function cb_l_eng_l_mag()
    ...
    msfs_variable_write("L:MAGNETO_BAR", "Enum", 1)
end
...
function cb_pump_l(position, direction)
    ...
    msfs_variable_write("L:GENERIC_Momentary_AUX_LEFT_PUMP_SWITCH", "Enum", newpos)
end
...
msfs_variable_subscribe("L:GENERIC_Momentary_AUX_LEFT_PUMP_SWITCH", "Enum", set_pump_l)
-- End Aux Pump Left
...
function leftPrimePress()
    --msfs_variable_write("L:GENERIC_Momentary_PRIMER_SWITCH", "ENUM", 0)
    sound_play(fail_snd)
end

function leftPrimeRelease()
    --msfs_variable_write("L:GENERIC_Momentary_PRIMER_SWITCH", "ENUM", 1)
    sound_play(fail_snd)
end
primer_left_btn_id = button_add(nil, nil, 355, 204, 90, 45, leftPrimePress, leftPrimeRelease)

function rightPrimePress()
    --msfs_variable_write("L:GENERIC_Momentary_PRIMER_SWITCH", "ENUM", 2)
    sound_play(fail_snd)
end
...
msfs_variable_subscribe("L:GENERIC_Momentary_PRIMER_SWITCH", "ENUM", setSwitchState)
-- End Primer

-- Starter L
function cb_start_l()
    msfs_variable_write("L:STARTER1", "Enum", 1)
    msfs_variable_write("L:TOGGLE_STARTER1", "Enum", 1)
end

function cb_start_l_release()
    msfs_variable_write("L:STARTER1", "Enum", 0)
    msfs_variable_write("L:TOGGLE_STARTER1", "Enum", 0)
end
...
-- Starter R
function cb_start_r()
     msfs_variable_write("L:STARTER2", "Enum", 1)
    msfs_variable_write("L:TOGGLE_STARTER2", "Enum", 1)
end
function cb_start_r_release()
    msfs_variable_write("L:STARTER2", "Enum", 0)
    msfs_variable_write("L:TOGGLE_STARTER2", "Enum", 0)
end
...
function cb_pump_r(position, direction)
    newpos= position + direction
    msfs_variable_write("L:GENERIC_Momentary_AUX_RIGHT_PUMP_SWITCH", "Enum", newpos)
end
...
msfs_variable_subscribe("L:GENERIC_Momentary_AUX_RIGHT_PUMP_SWITCH", "Enum", set_pump_r)
-- End Aux Pump Right
...
function cb_master_battery()
    msfs_variable_write("L:MASTER_BAR", "Enum", 1)
    if battery_master == 1 then
        msfs_variable_write("L:ELECTRICAL_Switch_Battery_Master", "Enum", 0)
        msfs_event("ELECTRICAL_BUS_TO_BUS_CONNECTION_TOGGLE",6,0)
    else
        msfs_variable_write("L:ELECTRICAL_Switch_Battery_Master", "Enum", 1)
        msfs_event("ELECTRICAL_BUS_TO_BUS_CONNECTION_TOGGLE",6,1)
    end
end
...
msfs_variable_subscribe("L:ELECTRICAL_Switch_Battery_Master", "Enum", 
...
function cb_alt_left()
    ...
    if alt_left == 1 then
        ...
        msfs_variable_write("L:ALTERNATOR_LEFT", "Enum", 0)
    else
        msfs_event("TOGGLE_ALTERNATOR1")
        msfs_variable_write("L:ALTERNATOR_LEFT", "Enum", 1)
    end 
end
...
msfs_variable_subscribe("L:ALTERNATOR_LEFT", "Enum", cb_set_alt_left)
--End Left Alternator
...
function cb_alt_right()
    msfs_variable_write("L:MASTER_BAR", "Enum", 1)
        ...
        msfs_variable_write("L:ALTERNATOR_right", "Enum", 0)
    else
        msfs_event("TOGGLE_ALTERNATOR2")
        msfs_variable_write("L:ALTERNATOR_right", "Enum", 1)
    end
end
...
msfs_variable_subscribe("L:ALTERNATOR_right", "Enum", cb_set_alt_right)
...
msfs_variable_subscribe("LIGHT STROBE", "Bool", cb_set_strobe)
--End Anti-Collision
...
msfs_variable_subscribe("LIGHT NAV", "Bool", cb_set_nav)
--End Nav
...
function  taxi_toggle()
    ...
    if taxi_light == 0 then
        msfs_variable_write("A:LIGHT_TAXI", "Enum",1)
        msfs_variable_write("L:LIGHT_TAXI", "Enum",1)
    else
        msfs_variable_write("A:LIGHT_TAXI", "Enum", 0)
        msfs_variable_write("L:LIGHT_TAXI", "Enum",0)
    end
end
...
msfs_variable_subscribe("LIGHT TAXI", "Number", 
...
function landing_toggle(position, direction)
    newpos= position + direction
    msfs_variable_write("L:GENERIC_Momentary_LIGHT_SWITCH_LANDING_1", "Enum", newpos)
end
...
msfs_variable_subscribe("L:GENERIC_Momentary_LIGHT_SWITCH_LANDING_1", "Enum", cb_set_landing)
--End Landing Light
---END LIGHTS---
...
function deice_toggle(position, direction)
    newpos= position + direction
    msfs_variable_write("L:GENERIC_Momentary_DEICE_ELECT", "Enum", newpos)
    if elect_deice == 1 then
        msfs_event("WINDSHIELD_DEICE_ON")
    else
        msfs_event("WINDSHIELD_DEICE_OFF")
    end
end
...
msfs_variable_subscribe("L:GENERIC_Momentary_DEICE_ELECT", "Enum", cb_set_antiice)
--End Anti-Ice

--Prop Ice
function prop_toggle()
    if prop_deice == 0 then
        msfs_variable_write("L:DEICE_PROP", "Enum", 1)
    else
        msfs_variable_write("L:DEICE_PROP", "Enum", 0)
    end
end
...
msfs_variable_subscribe("L:DEICE_PROP", "Enum", cb_set_prop)
--End Prop Ice
...
function surface_toggle(position, direction)
     ...
     if direction == 1 then
       msfs_variable_write("L:GENERIC_Momentary_DEICE_SURFACE", "Enum", 2)
       msfs_variable_write("L:STRUCTURAL_DEICE_MEMORY", "Enum", 1)     
     else
        msfs_variable_write("L:GENERIC_Momentary_DEICE_SURFACE", "Enum", 0)
        msfs_variable_write("L:STRUCTURAL_DEICE_MEMORY", "Enum", 0) 
        msfs_variable_write("L:STRUCTURAL_DEICE_CYCLE", "Enum", 0) 
     end
...
msfs_variable_subscribe("L:GENERIC_Momentary_DEICE_SURFACE", "Enum", cb_set_surface)
---END DE-ICE---
...
function fan_control(position, direction)
    newpos= position + direction
    msfs_variable_write("L:GENERIC_Momentary_CABIN_FAN", "Enum", newpos)
end
...
msfs_variable_subscribe("L:GENERIC_Momentary_CABIN_FAN", "Enum", cb_fan_set)
--End Cabin Fan

--Cabin Heat
function fan_control()
    if heat_switch == 0 then
        msfs_variable_write("L:CABIN_HEAT", "Number", 1)
    else
        msfs_variable_write("L:CABIN_HEAT", "Number", 0)
    end
end
...
msfs_variable_subscribe("L:CABIN_HEAT", "Number", cb_heat_set)
--End Cabin Heat
...
function stall_set()
    ...
    if stall_switch == 0 then
        msfs_variable_write("L:STALL_VENT_HEAT", "Number", 1)
    else
        msfs_variable_write("L:STALL_VENT_HEAT", "Number", 0)
    end
end
...
msfs_variable_subscribe("L:STALL_VENT_HEAT", "Enum", cb_stall_set)
-- End Stall Heat
...
msfs_variable_subscribe("PITOT HEAT", "Bool", pitot_set)
--End Pitot
--Avionics
...
msfs_variable_subscribe("AVIONICS MASTER SWITCH", "Bool", avionics_set)
--End Avionics
