...
function FMC_1_BTN_CLR_Start()
   fs2020_event("H:CJ4_FMC_" .. instr_pos .. "_BTN_CLR")
   sound_play(snd_click)
...
function CLR_LONG()
fs2020_event("H:CJ4_FMC_" .. instr_pos .. "_BTN_CLR_LONG")
end
...
function FMC_1_BTN_SP()
   fs2020_event("H:CJ4_FMC_" .. instr_pos .. "_BTN_SP")
   sound_play(snd_click)
end
button_add(nil,SPButtonPressed, 370,919,51,47, FMC_1_BTN_SP)
--DIV Button
function FMC_1_BTN_DIV()
   fs2020_event("H:CJ4_FMC_" .. instr_pos .. "_BTN_DIV")
   sound_play(snd_click)
end
